module Krudmin
  class ApplicationController < Krudmin::Config.parent_controller.constantize
    ...
    delegate :resource_label, :resources_label, :scope, :activate_path, :deactivate_path, :listable_actions, :listable_attributes, :resource_root, :model_class, :model_id, :editable_attributes, :grouped_attributes, :new_resource_path, :resource_path, :edit_resource_path, :resource_instance_label_attribute, :searchable_attributes, :field_for, to: :krudmin_manager
